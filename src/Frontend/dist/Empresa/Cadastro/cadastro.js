"use strict";
function setAvisoEmpresa(mensagem, tipo) {
...
formEmpresa === null || formEmpresa === void 0 ? void 0 : formEmpresa.addEventListener('submit', (e) => {
    e.preventDefault();
    const empsForm = carregarEmpresas();
    ...
    empsForm.push(novaEmpresa);
    salvarEmpresas(empsForm);
...
function renderizarVagas(empresas) {
...
function renderizarGrafico(candLista) {
